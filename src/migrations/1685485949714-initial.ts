...
export class Initial1685485949714 implements MigrationInterface {
    name = 'Initial1685485949714'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "doctor_clinic" RENAME COLUMN "doctor_id" TO "docotor_id"`);
        await queryRunner.query(`ALTER TABLE "doctor_clinic" RENAME CONSTRAINT "PK_9d26cc5ab300147e085bc0a2969" TO "PK_1a5e20e1ab06c69aa46c8dd2245"`);
        await queryRunner.query(`ALTER TABLE "doctor_clinic" RENAME COLUMN "docotor_id" TO "doctor_id"`);
        await queryRunner.query(`ALTER TABLE "doctor_clinic" RENAME CONSTRAINT "PK_1a5e20e1ab06c69aa46c8dd2245" TO "PK_9d26cc5ab300147e085bc0a2969"`);
        ...
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "fullname" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "age" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "post" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "experience" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "office" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "info" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "info" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "office" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "experience" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "post" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "age" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctors" ALTER COLUMN "fullname" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "doctor_clinic" DROP CONSTRAINT "PK_9d26cc5ab300147e085bc0a2969"`);
        await queryRunner.query(`ALTER TABLE "doctor_clinic" ADD CONSTRAINT "PK_21bbb4649e4f1213409c13f3da3" PRIMARY KEY ("clinic_id", "docotor_id", "doctor_id")`);
        await queryRunner.query(`ALTER TABLE "doctor_clinic" DROP CONSTRAINT "PK_1a5e20e1ab06c69aa46c8dd2245"`);
        await queryRunner.query(`ALTER TABLE "doctor_clinic" ADD CONSTRAINT "PK_21bbb4649e4f1213409c13f3da3" PRIMARY KEY ("clinic_id", "docotor_id", "doctor_id")`);
